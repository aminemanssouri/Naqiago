      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Card style={[styles.statusCard, { borderColor: getStatusColor(booking.status) }]}>
          ...
          <View style={styles.statusActions}>
            <StatusButton status="accepted" label="Accept" />
            <StatusButton status="in_progress" label="Start" />
            <StatusButton status="completed" label="Complete" />
          </View>
        </Card>
        ...
        <Card style={styles.sectionCard}>
          ...
          <View style={styles.contactActions}>
            ...
            >
              ...
              <Text style={[styles.contactButtonText, { color: theme.accent }]}>Call</Text>
            </Button>
            <Button
              variant="outline"
            ...
            >
              ...
              <Text style={[styles.contactButtonText, { color: theme.accent }]}>Message</Text>
            </Button>
          </View>
        </Card>
        ...
        <Card style={styles.sectionCard}>
          ...
          <View style={styles.locationActions}>
            ...
            >
              ...
              <Text style={[styles.locationButtonText, { color: theme.accent }]}>Navigate</Text>
            </Button>
            <Button
              variant="outline"
            ...
            >
              ...
              <Text style={[styles.locationButtonText, { color: theme.accent }]}>Reschedule</Text>
            </Button>
          </View>
        </Card>
            ...
            <View style={styles.notesEditContainer}>
              ...
              <View style={styles.notesActions}>
                ...
                >
                  ...
                  <Text style={[styles.notesActionText, { color: theme.textSecondary }]}>Cancel</Text>
                </Button>
                <Button
                ...
                >
                  ...
                  <Text style={[styles.notesActionText, { color: '#ffffff' }]}>Save</Text>
                </Button>
              </View>
            </View>
          ) : (
