...
const mockActivity: NotificationItem[] = [
  { id: 'n1', type: 'booking', title: 'Booking Confirmed', body: 'Your wash with Ahmed is confirmed for 10:00 AM', time: '2h', unread: true },
  { id: 'n2', type: 'booking', title: 'Booking Completed', body: 'Rate your experience with Omar', time: 'Yesterday' },
  { id: 'n3', type: 'system', title: 'Promo', body: 'Get 20% off your next Deluxe Wash', time: '2d' },
];
...
const mockMessages: NotificationItem[] = [
  ...
  { id: 'm2', type: 'message', title: 'Support', body: 'How was your recent booking?', time: '1d' },
];
            ...
            {item.type === 'booking' && (
              <>
                <TouchableOpacity activeOpacity={0.8} style={{ backgroundColor: theme.accent, paddingVertical: 8, paddingHorizontal: 12, borderRadius: 8 }}>
                  <Text style={{ color: '#fff', fontWeight: '600' }}>View Booking</Text>
                </TouchableOpacity>
                <TouchableOpacity activeOpacity={0.8} style={{ backgroundColor: theme.card, borderColor: theme.cardBorder, borderWidth: 1, paddingVertical: 8, paddingHorizontal: 12, borderRadius: 8 }}>
                  <Text style={{ color: theme.textPrimary, fontWeight: '600' }}>Rate</Text>
                </TouchableOpacity>
              </>
            )}
            {item.type === 'message' && (
