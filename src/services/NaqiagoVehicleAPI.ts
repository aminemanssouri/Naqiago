...
export const NaqiagoVehicleAPI = {
  ...
  getPopularBrands(): CarBrand[] {
    return [
      { id: 1, name: 'Toyota', logo: null, popular: true },
      { id: 2, name: 'Honda', logo: null, popular: true },
      { id: 3, name: 'Ford', logo: null, popular: true },
      { id: 4, name: 'Chevrolet', logo: null, popular: true },
      { id: 5, name: 'BMW', logo: null, popular: true },
      { id: 6, name: 'Mercedes-Benz', logo: null, popular: true },
      { id: 7, name: 'Audi', logo: null, popular: true },
      { id: 8, name: 'Nissan', logo: null, popular: true },
      { id: 9, name: 'Hyundai', logo: null, popular: true },
      { id: 10, name: 'Volkswagen', logo: null, popular: true }
    ];
  },
